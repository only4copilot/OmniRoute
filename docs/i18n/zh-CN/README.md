...
- **内置免费层级提供商** — 对 100% 免费提供商的本机支持：Qoder（8 个无限型号）、Qwen（3 个无限型号）、Kiro（Claude 免费）、Gemini CLI（180K/月免费）
...
| **🆓 免费**    | Qoder             | $0                    | 无限制          | 8 个免费模型 |
|                | Qwen              | $0                    | 无限制          | 3 个免费模型 |
|                | Kiro              | $0                    | 无限制          | 免费 Claude  |

**💡 专业建议：** 从 Gemini CLI（每月 180K 免费）+ Qoder（无限免费）开始 = $0 成本！
